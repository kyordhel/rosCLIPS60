...
/****************************************************
  ...
  NOTES        : None
 ****************************************************/
globle VOID DefinstancesCModuleReference(theFile,count,imageID,maxIndices)
  FILE *theFile;
  int count;
  int imageID;
  int maxIndices;
...
/*******************************************************
  ...
  NOTES        : None
 *******************************************************/
static int DefinstancesToCode(fileName,fileID,headerFP,imageID,maxIndices)
  char *fileName;
  int fileID;
  FILE *headerFP;
  int imageID;
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static VOID CloseDefinstancesFiles(moduleFile,definstancesFile,maxIndices)
  FILE *moduleFile, *definstancesFile; 
  int maxIndices;  
  {
   ...
   if (definstancesFile != NULL) 
     {
      count = maxIndices;
      definstancesFile = CloseFileIfNeeded(definstancesFile,&count,&arrayVersion,
                                           maxIndices,NULL,NULL);
     }
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static VOID DefinstancesModuleToCode(theFile,theModule,imageID,maxIndices)
  FILE *theFile;
  struct defmodule *theModule;
  int imageID;
  int maxIndices;
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static VOID SingleDefinstancesToCode(theFile,theDefinstances,imageID,maxIndices,moduleCount)
  FILE *theFile;
  DEFINSTANCES *theDefinstances;
  int imageID;
  int maxIndices;
