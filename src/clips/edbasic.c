...
globle int filevisit_guts(fname)
char fname[];
{
        register BUFFER *bp;
        register WINDOW *wp;
 ...
 */
globle int makename(bname, fname)
char    bname[];
char    fname[];
{
        register char   *cp1;
