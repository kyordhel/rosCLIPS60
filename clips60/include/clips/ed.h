...
LOCALE int backword();
LOCALE int forwword();
LOCALE int upperword();
LOCALE int lowerword();
LOCALE int capword();
LOCALE int delfword();
LOCALE int delbword();
LOCALE int inword();
LOCALE int killregion();
LOCALE int copyregion();
LOCALE int upperregion();
LOCALE int lowerregion();
LOCALE int getregion();
LOCALE int fileread();
LOCALE int filevisit();
LOCALE int filevisit_guts();
LOCALE int readin();
LOCALE int makename();
LOCALE int filewrite();
LOCALE int filesave();
LOCALE int writeout();
LOCALE int filename();
LOCALE int ffropen();
LOCALE int ffwopen();
LOCALE int ffclose();
LOCALE int ffputline();
LOCALE int ffgetline();
LOCALE VOID ttopen();
LOCALE VOID ttclose();
LOCALE VOID ttputc();
LOCALE VOID ttflush();
...
LOCALE int getkey();
LOCALE int getctl();
LOCALE int quickexit();
LOCALE int edquit();
LOCALE int temp_quit();
LOCALE int ctlxlp();
LOCALE int ctlxrp();
LOCALE int ctlxe();
LOCALE int ctrlg();
LOCALE VOID full_cleanup();
LOCALE int kill_all_buffers();
LOCALE int kill_all_windows();
LOCALE int spec_clear();
LOCALE VOID EditCommand();
LOCALE VOID EditorFunctionDefinition();
#endif
...
#else
LOCALE int compile_region();
LOCALE int compile_file();
LOCALE int get_compile();
LOCALE int region_fnd();
LOCALE int region_getc();
LOCALE int region_ungetc();
LOCALE int buffer_fnd();
LOCALE int buffer_getc();
LOCALE int buffer_ungetc();
LOCALE int query_cmp();
LOCALE int print_cmp();
LOCALE VOID init_cmp_router();
LOCALE VOID kill_cmp_router();
LOCALE int setfillcol();
LOCALE int showcpos();
LOCALE int getccol();
LOCALE int getcline();
LOCALE int cntlines();
...
LOCALE int kill_fwd();
LOCALE int yank();
LOCALE int forwsearch();
LOCALE int backsearch();
LOCALE int bkwrdrpl();
LOCALE int bkwrdcr();
LOCALE int frwsr();
LOCALE int querysr();
...
#else
LOCALE int usebuffer();
LOCALE int killbuffer();
LOCALE int listbuffers();
LOCALE int makelist();
LOCALE int addline();
LOCALE int anycb();
LOCALE BUFFER *bfind();
...
LOCALE int lnewline();
LOCALE int ldelete();
LOCALE int ldelnewline();
LOCALE VOID kdelete();
LOCALE int kinsert();
LOCALE int kremove();
LOCALE int reposition();
LOCALE int EditorRefresh();
LOCALE int nextwind();
LOCALE int prevwind();
LOCALE int mvdnwind();
LOCALE int mvupwind();
LOCALE int onlywind();
LOCALE int splitwind();
LOCALE int enlargewind();
LOCALE int shrinkwind();
LOCALE WINDOW *wpopup();
LOCALE VOID vtinit();
LOCALE VOID vttidy();
LOCALE VOID vtmove();
LOCALE VOID vtputc();
LOCALE VOID vteeol();
LOCALE VOID update();
LOCALE VOID updateline();
LOCALE VOID modeline();
LOCALE VOID movecursor();
LOCALE VOID mlerase();
LOCALE int mlyesno();
LOCALE int mlreply();
LOCALE VOID mlwrite();
...
LOCALE VOID mlputi();
LOCALE VOID mlputli();
LOCALE VOID kill_video_buffers();
#endif
