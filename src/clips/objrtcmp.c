...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
globle VOID ObjectPatternNodeReference(theVPattern,theFile,imageID,maxIndices)
  VOID *theVPattern;
  FILE *theFile;
  int imageID;
  int maxIndices;
 ...
 ***************************************************/
static OBJECT_PATTERN_NODE *GetNextObjectPatternNode(thePattern)
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static VOID InitObjectPatternsCode(initFP,imageID,maxIndices)
  FILE *initFP;
  int imageID;
  int maxIndices;
  {
...
/***********************************************************
  ...
  NOTES        : None
 ***********************************************************/
static int ObjectPatternsToCode(fileName,fileID,headerFP,imageID,maxIndices)
  char *fileName;
  int fileID;
  FILE *headerFP;
  int imageID;
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static VOID IntermediatePatternNodeReference(thePattern,theFile,imageID,maxIndices)
  OBJECT_PATTERN_NODE *thePattern;
  FILE *theFile;
  int imageID;
  int maxIndices;
...
/*************************************************************
  ...
  NOTES        : None
 *************************************************************/
static int IntermediatePatternNodesToCode(fileName,fileID,headerFP,imageID,maxIndices,version)
  char *fileName;
  int fileID;
  FILE *headerFP;
  int imageID;
...
/***********************************************************
  ...
  NOTES        : None
 ***********************************************************/
static int AlphaPatternNodesToCode(fileName,fileID,headerFP,imageID,maxIndices,version)
  char *fileName;
  int fileID;
  FILE *headerFP;
  int imageID;
