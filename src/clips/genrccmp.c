...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
globle VOID PrintGenericFunctionReference(fp,gfunc,imageID,maxIndices)
  FILE *fp;
  DEFGENERIC *gfunc;
...
/****************************************************
  ...
  NOTES        : None
 ****************************************************/
globle VOID DefgenericCModuleReference(theFile,count,imageID,maxIndices)
  FILE *theFile;
  int count;
  int imageID;
  int maxIndices;
...
/*******************************************************
  ...
  NOTES        : None
 *******************************************************/
static int DefgenericsToCode(fileName,fileID,headerFP,imageID,maxIndices)
  char *fileName;
  int fileID;
  FILE *headerFP;
  int imageID;
...
/******************************************************
  ...
  NOTES        : None
 *****************************************************/
static VOID CloseDefgenericFiles(itemFiles,itemReopenFlags,itemCodeFiles,maxIndices)
  FILE *itemFiles[SAVE_ITEMS];
  int itemReopenFlags[SAVE_ITEMS];
  struct CodeGeneratorFile itemCodeFiles[SAVE_ITEMS]; 
  int maxIndices;  
...
/***************************************************
  ...
  NOTES        : None
 ***************************************************/
static VOID DefgenericModuleToCode(theFile,theModule,imageID,maxIndices)
  FILE *theFile;
  struct defmodule *theModule;
  int imageID;
  int maxIndices;
...
/****************************************************************
  ...
  NOTES        : None
 ***************************************************************/
static VOID SingleDefgenericToCode(theFile,imageID,maxIndices,theDefgeneric,moduleCount,
                                   methodArrayVersion,methodArrayCount)
  FILE *theFile;
  int imageID,maxIndices;
  DEFGENERIC *theDefgeneric;
  int moduleCount,methodArrayVersion,methodArrayCount;
  {
   /* ==================
      Defgeneric Header
      ================== */
...
/****************************************************************
  ...
  NOTES        : None
 ***************************************************************/
static VOID MethodToCode(theFile,imageID,theMethod,
                         restrictionArrayVersion,restrictionArrayCount)
  FILE *theFile;
  int imageID;
  DEFMETHOD *theMethod;
  int restrictionArrayVersion,restrictionArrayCount;
  {
...
/****************************************************************
  ...
  NOTES        : None
 ***************************************************************/
static VOID RestrictionToCode(theFile,imageID,theRestriction,
                              typeArrayVersion,typeArrayCount)
  FILE *theFile;
  int imageID;
  RESTRICTION *theRestriction;
  int typeArrayVersion,typeArrayCount;
  {
   fprintf(theFile,"{");
...
/****************************************************************
  ...
  NOTES        : None
 ***************************************************************/
static VOID TypeToCode(theFile,imageID,theType,maxIndices)
  FILE *theFile;
  int imageID;
  VOID *theType;
  int maxIndices;
