...
/**************************************************************/
/* factConstantPN2Call: Used for testing for a constant value */
...
/******************************************************************/
/* factConstantPN4Call: Used for testing for a constant value in  */
...
/****************************************/
   ...
   LOCALE struct expr               *FactPNVariableComparison();
   LOCALE struct expr               *FactJNVariableComparison();
   LOCALE VOID                       FactReplaceGetvar();
   LOCALE VOID                       FactReplaceGetfield();
   LOCALE struct expr               *FactGenPNConstant();
   LOCALE struct expr               *FactGenGetfield();
